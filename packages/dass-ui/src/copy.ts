...
export const COPY = {
  ...
  roomExpired: 'انتهت صلاحية الغرفة — افتحوا غرفة جديدة',
  roomClosed: 'الغرفة مقفلة — اللعبة خلصت',
  roomFull: 'الغرفة كاملة (٨ لاعبين)',
  emptyCode: 'اكتب كود الغرفة',
  invalidCode: 'كود الغرفة غير صحيح',
  emptyName: 'اكتب اسمك',
  nameTooLong: 'الاسم طويل — الحد ٢٠ حرف',
  unsupportedName: 'الاسم فيه رموز غير مدعومة',
  invalidToken: 'جلسة اللاعب غير صالحة — امسح بيانات الموقع وجرب من جديد',
