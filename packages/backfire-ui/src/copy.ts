...
export const COPY = {
  ...
  present: 'حاضرون',
  readyPlural: 'جاهزون',
  crewComplete: 'الطاقم مكتمل',
  crewReady: 'استعدّوا — كل واحد يضغط «جاهز» على جوّاله',
  everyoneReady: 'الكل جاهز',
  allReadyGo: 'كلكم جاهزون — اضغط ابدأ',
  hostStarts: 'التلفاز يبدأ الجولة',
  matchStarting: 'تبدأ الجولة',
  start: 'ابدأ',
  ...
  supportHint: 'زائد واحد لقوّة مساره',
  disruptHint: 'ناقص واحد من قوّة مساره',
  redirectHint: 'ينفع فقط إذا كان المصدر مدعوماً',
